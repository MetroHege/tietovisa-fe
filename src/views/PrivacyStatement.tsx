  ...
  return (
    <div className="max-w-3xl mx-auto p-4 text-left">
      ...
      <p className="mb-4 text-gray-900 dark:text-white">
        ...
        tietosuojakäytäntöjä. Käytämme mahdollisimman vähän henkilötietoja.
        Palveluamme voi käyttää myös ilman rekisteröitymistä. Rekisteröitymistä
        varten kysymme tunnistautumistietona minimissään vain vapaavalintaisen
        käyttäjätunnuksen ja sähköpostiosoitteen.
      </p>
      <p className="mb-4 text-gray-900 dark:text-white">
      ...
      <ul className="mb-6 list-disc list-inside text-gray-900 dark:text-white">
        <li>
          Henkilön perustiedot ja tunnistautumiseen liittyvät tiedot, kuten
          nimimerkki, käyttäjätunnus tai muu yksilöivä tunniste ja
          sähköpostiosoite. Minkään näistä ei tarvitse olla sellainen, josta
          käyttäjän henkilöllisyys käy ilmi.
        </li>
        <li>
          Tieto käyttäjän tilaamista ilmoituspalveluista kuten uutiskirjeistä ja
          päivityksistä.
        </li>
        <li>
          Käyttäjän itse tuottama sisältö, joka perustuu käyttäjän
          yhteydenottoihin kuten käyttäjän tekemiin virheilmoituksiin.
        </li>
        <li>
          Käyttäjän antamat luvat ja suostumukset sekä kilpailuihin ja
          arvontoihin liittyvät tiedot.
        </li>
        <li>
          Tutkimus- ja kyselytiedot. Jos toteutamme palveluita koskevia
          kyselyitä, vastausten käsittely toteutetaan vastaajien halutessa
      ...
      <ul className="mb-6 list-disc list-inside text-gray-900 dark:text-white">
        ...
        <li>
          Tekniset tiedot ja laitetiedot, laitetunnisteet ja päätelaitetta
          koskevat tiedot kuten esimerkiksi päätelaitteen malli, laite- ja/tai
          evästetunniste, käyttöjärjestelmä, selain tai sovellus ja sen versio,
          IP-osoite, istuntotunniste, istunnon aika ja sen kesto.
        </li>
        <li>
          Analytiikka- ja tilastotiedot, kuten verkkopalvelujen
          analytiikkajärjestelmien keräämät tilastointitiedot.
        </li>
      ...
      <ul className="mb-6 list-disc list-inside text-gray-900 dark:text-white">
        ...
        <li>Uutiskirjeiden ja muiden ilmoitusten lähettäminen</li>
      ...
      <p className="mb-4 text-gray-900 dark:text-white">
        ...
        rekisteröityessään käyttäjäksi, hän hyväksyy käyttöehdot ja pyytämiemme
        henkilötietojen käyttöperusteet, mistä syntyy oikeudellinen peruste
        henkilötietojen käsittelyyn. Käyttäjä antaa palveluamme käyttäessään
        myös suostumuksensa henkilötietojen käsittelyyn.
      </p>
      <p className="mb-4 text-gray-900 dark:text-white">
        Saatamme käsitellä henkilötietoja myös palvelumme asianmukaisen tarpeen
      ...
      <ul className="mb-6 list-disc list-inside text-gray-900 dark:text-white">
        ...
        <li>
          oman ja asiakkaidemme tietoturvan ja muun turvallisuuden
          varmistamiseksi
        </li>
      ...
      <p className="mb-4 text-gray-900 dark:text-white">
        ...
        tapahtuu toimivaltaisen viranomaisen vaatimuksesta ja vain lakiin
        perustuvien edellytysten mukaisesti. Sosiaalisen median kumppaneille
      ...
      <p className="mb-6 text-gray-900 dark:text-white">
        ...
        periaatteita ja toimintatapoja. Voimme tarjota palveluitamme useilla
        laitealustoilla. Palvelut voivat sisältää linkkejä tai pääsyn muiden
        toimijoiden sivustoille tai palveluihin. Jos palveluitamme käyttää
        muiden toimijoiden sivustojen kautta tai sovelluksilla, kyseisten
        toimijoiden omat ja meistä riippumattomat tietosuojakäytännöt ja
      ...
      <p className="mb-6 text-gray-900 dark:text-white">
        ...
        palvelumme saattaa käyttää myös muualla sijaitsevia toimijoita,
        palveluja ja palvelimia. Tällöin henkilötietoja voi siirtyä EU- tai
      ...
      <p className="mb-6 text-gray-900 dark:text-white">
        ...
        Säilytysajan päättyessä poistamme tiedot tai muutamme ne muotoon, jossa
        käyttäjiä ei voi tunnistaa. Arvontojen ja kilpailujen tiedot poistetaan
      ...
      <p className="text-gray-900 dark:text-white">
        Henkilötietojesi rekisterinpitäjänä toimii Pressmen Finland Oy.
      </p>
    </div>
  );
};
